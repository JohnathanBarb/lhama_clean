...
class RegisterPet(RegisterPetInterface):
    ...
    def registry(
        ...
        :return - Dictionary with information of the proccess
        """
    ...
    def __find_user_information(
        ...
        :return - Dictionary with the response of the find_user use case
        """
        ...
        if "user_id" in user_params and "user_name" in user_params:
            ...
            user_founded = self.find_user.by_id(user_params["user_id"])
